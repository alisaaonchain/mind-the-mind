...
export function SampleRound() {
  return (
    <section id="sample" className="relative border-t border-ink-line py-20 sm:py-28">
        ...
        <Reveal>
          <div className="mb-12 flex flex-wrap items-end justify-between gap-4">
            ...
            <p className="max-w-md text-bone-dim">
              ...
              objective and its private reasoning, ticking by in real time. Right is
              everything you actually saw. The gap between them is the whole game.
            </p>
          </div>
        </Reveal>
